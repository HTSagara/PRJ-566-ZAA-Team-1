...
import { ConflictHandler, DataStoreConfig, DataStoreSnapshot, ErrorHandler, IdentifierFieldOrIdentifierObject, ModelPredicateExtender, ObserveQueryOptions, PersistentModel, PersistentModelConstructor, PersistentModelMetaData, ProducerPaginationInput, RecursiveModelPredicateExtender, Schema, SubscriptionMessage, TypeConstructorMap } from '../types';
...
declare class DataStore {
    ...
    observeQuery: <T extends PersistentModel>(modelConstructor: PersistentModelConstructor<T>, criteria?: RecursiveModelPredicateExtender<T> | typeof PredicateAll, paginationProducer?: ObserveQueryOptions<T>) => Observable<DataStoreSnapshot<T>>;
