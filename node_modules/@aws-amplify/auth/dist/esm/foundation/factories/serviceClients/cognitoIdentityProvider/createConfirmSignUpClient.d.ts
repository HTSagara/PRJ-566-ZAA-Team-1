import { ConfirmSignUpCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createConfirmSignUpClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").ConfirmSignUpRequest) => Promise<ConfirmSignUpCommandOutput>;
