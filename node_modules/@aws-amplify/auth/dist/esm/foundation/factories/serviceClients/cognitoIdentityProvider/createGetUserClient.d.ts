import { GetUserCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createGetUserClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").GetUserRequest) => Promise<GetUserCommandOutput>;
