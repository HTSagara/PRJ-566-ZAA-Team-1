import { ConfirmDeviceCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createConfirmDeviceClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").ConfirmDeviceRequest) => Promise<ConfirmDeviceCommandOutput>;
