import { ServiceClientFactoryInput, UpdateDeviceStatusCommandOutput } from './types';
export declare const createUpdateDeviceStatusClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").UpdateDeviceStatusRequest) => Promise<UpdateDeviceStatusCommandOutput>;
