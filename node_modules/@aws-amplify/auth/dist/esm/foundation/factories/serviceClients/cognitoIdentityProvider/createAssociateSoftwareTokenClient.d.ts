import { AssociateSoftwareTokenCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createAssociateSoftwareTokenClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").AssociateSoftwareTokenRequest) => Promise<AssociateSoftwareTokenCommandOutput>;
