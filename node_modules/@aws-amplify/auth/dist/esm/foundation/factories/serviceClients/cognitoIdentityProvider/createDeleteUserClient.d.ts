import { DeleteUserCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createDeleteUserClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").DeleteUserRequest) => Promise<DeleteUserCommandOutput | undefined>;
