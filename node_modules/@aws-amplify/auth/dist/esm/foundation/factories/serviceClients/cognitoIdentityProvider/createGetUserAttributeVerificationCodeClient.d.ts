import { GetUserAttributeVerificationCodeCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createGetUserAttributeVerificationCodeClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").GetUserAttributeVerificationCodeRequest) => Promise<GetUserAttributeVerificationCodeCommandOutput>;
