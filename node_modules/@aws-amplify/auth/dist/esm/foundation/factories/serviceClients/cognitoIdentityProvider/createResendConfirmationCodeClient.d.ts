import { ResendConfirmationCodeCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createResendConfirmationCodeClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").ResendConfirmationCodeRequest) => Promise<ResendConfirmationCodeCommandOutput>;
