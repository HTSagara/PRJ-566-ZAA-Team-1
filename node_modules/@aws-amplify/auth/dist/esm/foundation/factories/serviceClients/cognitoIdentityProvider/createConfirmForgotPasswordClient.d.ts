import { ConfirmForgotPasswordCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createConfirmForgotPasswordClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").ConfirmForgotPasswordRequest) => Promise<ConfirmForgotPasswordCommandOutput>;
