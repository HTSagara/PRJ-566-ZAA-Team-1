import { InitiateAuthCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createInitiateAuthClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").InitiateAuthRequest) => Promise<InitiateAuthCommandOutput>;
