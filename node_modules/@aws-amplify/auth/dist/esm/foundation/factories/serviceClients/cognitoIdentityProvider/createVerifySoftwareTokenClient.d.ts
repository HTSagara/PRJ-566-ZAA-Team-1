import { ServiceClientFactoryInput, VerifySoftwareTokenCommandOutput } from './types';
export declare const createVerifySoftwareTokenClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").VerifySoftwareTokenRequest) => Promise<VerifySoftwareTokenCommandOutput>;
