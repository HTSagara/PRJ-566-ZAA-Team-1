import { ServiceClientFactoryInput, VerifyUserAttributeCommandOutput } from './types';
export declare const createVerifyUserAttributeClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").VerifyUserAttributeRequest) => Promise<VerifyUserAttributeCommandOutput>;
