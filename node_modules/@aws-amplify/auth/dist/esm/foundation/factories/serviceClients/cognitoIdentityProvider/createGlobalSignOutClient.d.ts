import { GlobalSignOutCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createGlobalSignOutClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").GlobalSignOutRequest) => Promise<GlobalSignOutCommandOutput>;
