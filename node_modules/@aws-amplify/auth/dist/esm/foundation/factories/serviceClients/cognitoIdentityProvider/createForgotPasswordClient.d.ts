import { ForgotPasswordCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createForgotPasswordClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").ForgotPasswordRequest) => Promise<ForgotPasswordCommandOutput>;
