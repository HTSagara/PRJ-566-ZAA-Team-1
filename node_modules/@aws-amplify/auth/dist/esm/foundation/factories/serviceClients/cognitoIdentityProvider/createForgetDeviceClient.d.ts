...
export declare const createForgetDeviceClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").ForgetDeviceRequest) => Promise<import("@smithy/types").MetadataBearer | undefined>;
