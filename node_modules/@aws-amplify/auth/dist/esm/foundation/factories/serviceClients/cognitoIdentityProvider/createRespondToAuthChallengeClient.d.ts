import { RespondToAuthChallengeCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createRespondToAuthChallengeClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").RespondToAuthChallengeRequest) => Promise<RespondToAuthChallengeCommandOutput>;
