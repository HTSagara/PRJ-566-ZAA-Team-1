import { ServiceClientFactoryInput, UpdateUserAttributesCommandOutput } from './types';
export declare const createUpdateUserAttributesClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").UpdateUserAttributesRequest) => Promise<UpdateUserAttributesCommandOutput>;
