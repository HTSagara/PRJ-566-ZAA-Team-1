import { ListDevicesCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createListDevicesClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").ListDevicesRequest) => Promise<ListDevicesCommandOutput>;
