import { DeleteUserAttributesCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createDeleteUserAttributesClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").DeleteUserAttributesRequest) => Promise<DeleteUserAttributesCommandOutput>;
