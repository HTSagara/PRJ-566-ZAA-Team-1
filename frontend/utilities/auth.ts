...
async function getUser(): Promise<User | null> {
  try {
    ...
    const idToken = currentAuthUser.getSignInUserSession()?.getIdToken().getJwtToken();
    const accessToken = currentAuthUser.getSignInUserSession()?.getAccessToken().getJwtToken();
